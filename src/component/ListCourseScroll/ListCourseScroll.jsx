...
function ListCourseScroll({ data }) {
    ...
    useEffect(() => {
        const scrollDiv = document.getElementById(`imageListCourseScroll-${data.id}`);
    ...
    return (
        <div className="listCourseScroll">
            <div className="listCourseScroll__heading">{data.heading}</div>
            <div className="listCourseScroll__card" id={`imageListCourseScroll-${data.id}`}>

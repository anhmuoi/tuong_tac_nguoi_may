import { Article, LiveTv, Quiz } from "@mui/icons-material";
        ...
        <div className="program">
            ...
            <div className="program__page">
                ...
                <div className="program__detail">
                    ...
                    program__title"
                    >
                        Post Graduate Program in Digital Marketing by Edubabble
                        LLP
                    </div>
                    <div className="program__desc">
                        LIVE1h 0m - Wed Nov 16 2022 17:30:00
                    </div>
                </div>
            </div>
            <div className="program__page">
                ...
                <div className="program__detail">
                    ...
                    <div className="program__desc">15 Questions</div>
                </div>
            </div>
        </div>
    );

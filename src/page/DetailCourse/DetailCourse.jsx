    ...
    return (
        <div className="detail">
            <div className="detail__left">
                <div className="detail__left-page">
            ...
            <div className="detail__right">
                <div className="detail__share">
                    ...
                    <div className="detail__left-follow">Tell your friends about this Course, so they too can get benefits</div>
                    <div className="detail__share-content">
                        {dataSocial.map((item) => (
                            <>
                                <div className="detail__share-item" key={item.id}>
                                    <img src={item.img} alt=""></img>
                                    <div className="detail__left-follow">{item.name}</div>
                                </div>
                            </>
                        ))}
                    </div>

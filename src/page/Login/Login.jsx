...
import lgFooter from "../../assets/Images/lgFooter.png";
...
const dataCommunity = [
    {
        id: 1,
        title: "Students",
        desc: "My situation was well understood by the counselor. She told me in great detail about everything I needed to know about the course. Thank you very much, Research; I appreciate it very much.",
    },
        ...
        <div className="login">
            <div className="nav">
                ...
                <div className="nav__auth">
                    <div
                        className={`nav__signUp ${isLogin ? "" : "active"}`}
                        onClick={() => handleClickSignup()}
                    >
                        Sign Up
                    </div>
                    <div
                        className={`nav__login ${isLogin ? "active" : ""}`}
            ...
            <div className="login__container">
                <div className="login__left">
                    ...
                    <div className="login__desc">
                        Provide accessible education, a community where learners
                        can interact with peers/teachers to share knowledge and
                        support learners.
                    </div>
            ...
            <div className="login__intro">
                ...
                <div className="login__answer">
                    Connecting Teachers and Learners, we provide online learning
                    solutions that can assist you in achieving your objectives,
                    whether they involve finding a new interest, upgrading your
                    career, or switching professions.
                </div>
            </div>
            <div className="login__explore">
                <div className="login__explore-heading">
                    ...
                    {dataExplore.map((item) => (
                        <>
                            <div className="login__category-item">
                                <img
                                    className="login__category-img"
                                    src={item.img}
                                    alt=""
                                />
                                <div className="login__category-content">
                                    <div className="login__category-name1">
                                        {item.name1}
                                    </div>
                                    <div className="login__category-name2">
                                        {item.name2}
                                    </div>
                                </div>
                            </div>
            ...
            <div className="login__community">
                ...
                <div className="login__connect">
                    {dataCommunity.map((item) => (
                        <>
                            <div
                                className={`login__connect-item ${
                                    idCommunity === item.id ? "active" : ""
                                }`}
                ...
                {dataCommunity.map((item) => {
                    if (item.id === idCommunity) {
                        return (
                            <>
                                <div className="login__connect-desc">
                                    {item.desc}
                                </div>
                            </>
                        );
